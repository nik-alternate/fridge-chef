...
BROKE_LOADING_MESSAGES = [
    ...
    "📦 Checking what's expired but probably still fine...",
    "🐟 Considering the canned tuna situation...",
    "🧅 Ah yes, one onion. The foundation of every broke meal...",
    "🥚 Eggs again? Classic.",
    "🔍 Looking for protein that won't require a loan...",
    "💡 Consulting the ghost of meals past...",
    "🏷️ Finding the best use of those mystery leftovers...",
    "🧮 Running the numbers... yeah, you're broke...",
    "🛖 Building something beautiful out of almost nothing...",
    "🪤 Trapping flavor on a shoestring budget...",
    "📱 Googling 'what to make with literally nothing'...",
    "🫠 Pretending this is a choice and not a necessity...",
    "🍞 Bread is technically a meal. We're working with that.",
    "🎰 Rolling the dice on your fridge contents...",
]
...
ALPHA_LOADING_MESSAGES = [
    ...
    "🛥️ Radioing the yacht chef for inspiration...",
    "🌿 Sourcing microgreens from a guy named François...",
    "🔪 Sharpening the Japanese steel...",
    "🫐 Confirming the truffle is in season...",
    "🧑‍🍳 Bribing a Michelin-star chef for their secrets...",
    "📜 Consulting a recipe older than your bloodline...",
    "🏔️ Waiting for the saffron to arrive by helicopter...",
    "🧊 Chilling the plates like a professional...",
    "🎻 Hiring a violinist for ambiance while you cook...",
    "💍 Deciding between the gold or diamond garnish...",
    "🦅 Ethically sourcing ingredients from a mountain top...",
    "🕯️ Setting the vibe before the wagyu even touches the pan...",
    "📡 Calling the fisherman directly for today's catch...",
    "🧬 Verifying the wagyu's A5 certification...",
    "🫧 Drawing a bath for the lobster tails...",
    "🌊 Flying in sea salt from a specific cliff in Portugal...",
    "🍋 Zesting with intention and purpose...",
    "👨‍🍳 Consulting the chef who cooked for the King...",
    "🪄 Turning your kitchen into a fine dining experience...",
